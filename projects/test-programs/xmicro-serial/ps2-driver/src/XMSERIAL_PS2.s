...
.EXPORT XMSERIAL_INIT, PS2_GETKEY, PS2_COMMAND, ASCII_NORMAL_TABLE, ASCII_SHIFT_TABLE
.CONDES XMSERIAL_INIT, CONSTRUCTOR

;ADDRESS CONSTANTS
	; XMSERIAL_SLOT		= 2						;BACKPLANE SLOT OF CARD
	; CARD_BASE		= $7000+(XMSERIAL_SLOT*$100)
	; CARD_IRQ_VECTOR	= __VT_START__+(XMSERIAL_SLOT*$4)
...
; RETURNS: Y - NEXT KEYCODE ($00 INDICATES NO NEW KEYS - Z SET)
; CLOBBERS: A,X,Y
;-----------------------------------------------------------------------------
.PROC PS2_GETKEY
