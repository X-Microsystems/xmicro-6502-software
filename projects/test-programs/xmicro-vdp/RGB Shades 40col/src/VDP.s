...
.IMPORT __XMICRO_VDP_START__, __XMICRO_VDP_VECTOR__, __XMICRO_MEMORY_START__, __XMICRO_6502_START__	;LINKER-GENERATED SYSTEM INFO
...
.SEGMENT "ONCE"
	...
	VDP_VECTOR := __XMICRO_VDP_VECTOR__
	XMICRO_MEMORY := __XMICRO_MEMORY_START__
	RTC := XMICRO_MEMORY+$10
	XMICRO_6502 := __XMICRO_6502_START__
...
;	WREG #%00010000, 0	;$00, $80	;TEXT1 MODE			;MOVED TO END OF STARTUP DUE TO NMI
;	WREG #%01010000, 1	;$50, $81	;IE0 DISABLED
	WREG #%00000000, 1	;$50, $81					;DISABLE SCREEN AND INTERRUPTS UNTIL END OF CONSTRUCTOR
...
;COLOR NAMES
	...
	WREG #%00000000, 14
	MVA #%11110000, VDP+1
	MVA #%01000000, VDP+1		;SET UP ADDRESS ($01E0), WRITE-MODE
	LDA #$47			;G
	STA VDP+0
	LDA #$52			;R
	STA VDP+0
	...
	WREG #%00000000, 14
	MVA #%11100000, VDP+1
	MVA #%01000001, VDP+1		;SET UP ADDRESS ($03C0), WRITE-MODE
	LDA #$42			;B
	STA VDP+0
	LDA #$4C			;L
	STA VDP+0
	...
	WREG #%00000000, 14
	MVA #%11010000, VDP+1
	MVA #%01000010, VDP+1		;SET UP ADDRESS ($05A0), WRITE-MODE
	LDA #$57			;W
	STA VDP+0
	LDA #$48			;H
	STA VDP+0
...
@MD4:
	...
	LDA #$00
	STA NEXTLINE
	WREG #%00010000, 0	;$00, $80	;TEXT1 MODE, IE1 ENABLED
	WREG #%01110000, 1	;$50, $81	;IE0 ENABLED
	RTS
...
H_INT:
	...
	CLC
	ADC #$06
	CMP #$BF		;DON'T BOTHER IF IT'S THE LAST LINE
	BEQ @1
	STA NEXTLINE
	WREG NEXTLINE, 19
@1:	RTI
